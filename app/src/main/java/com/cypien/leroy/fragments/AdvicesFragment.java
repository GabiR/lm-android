    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        clipboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData clip = ClipData.newPlainText("url", "http://www.facem-facem.ro/sfaturi.php");
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "http://www.facem-facem.ro/sfaturi.php");
                startActivity(Intent.createChooser(intent, "Distribuiţi cu"));
            }
        });

        urlLabel.setText("http://www.facem-facem.ro/sfaturi.php");
