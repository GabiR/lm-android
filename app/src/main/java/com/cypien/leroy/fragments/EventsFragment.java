...
public class EventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) actionBarView.findViewById(R.id.title)).setText("Evenimente");
    ...
    private void loadPage(){
        if(Connections.isNetworkConnected(getActivity())){
            ...
            new PageLoader((MainActivity) getActivity(), mWebView).execute("http://www.facem-facem.ro/events.php");
        }else {
            noInternet.setVisibility(View.VISIBLE);
        }
    }
