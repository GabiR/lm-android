...
public class TopUsersFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) actionBarView.findViewById(R.id.title)).setText("Top utilizatori");
    ...
    private void loadPage(){
        if(Connections.isNetworkConnected(getActivity())){
            ...
            new PageLoader((MainActivity) getActivity(), mWebView).execute("http://www.facem-facem.ro/leaderboards.php");
        }else {
            noInternet.setVisibility(View.VISIBLE);
        }
    }
