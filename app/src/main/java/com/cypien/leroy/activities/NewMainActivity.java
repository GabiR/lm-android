...
import com.cypien.leroy.utils.OnSwipeTouchListener;
...
public class NewMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (ok) {
                    if (Connections.isNetworkConnected(getApplicationContext())) {
                        ...
                        new NotificationDialog(NewMainActivity.this,"Vă rugăm să vă conectați la internet pentru a putea intra în cont!").show();
                    }
                }
            }
        });
        ...
        btnLoginFb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                initFacebook();
                if (Connections.isNetworkConnected(getApplicationContext())) {
                    SimpleFacebook.getInstance(NewMainActivity.this).login(new OnLoginListener() {
                        @Override
                            ...
                            SimpleFacebook.getInstance().getProfile(properties, new OnProfileListener() {
                                ...
                                public void onComplete(Profile profile) {
                                    if (profile.getEmail() != null) {
                                        ...
                                        new NotificationDialog(NewMainActivity.this,"Nu vă puteți conecta prin Facebook întrucât nu ați fost de accord cu preluarea informațiilor dumneavoastră").show();
                                    }
                                }
                            });
                        }
    ...
    private boolean init() {
        ...
        try {
            ...
            new NotificationDialog(NewMainActivity.this,"Ne cerem scuze, dar platforma nu funcționează. Vă rugăm reveniți.").show();
            e.printStackTrace();
        }
        return true;
    }
        ...
        if(init()) {
            ...
            try {
                ...
                if (acces.contains("redirect_login")) {
                    ...
                    spEditor.commit();
                    Intent intent = new Intent(NewMainActivity.this, CommunityMainActivity.class);
                    startActivity(intent);
                    finish();
                } else
                    new NotificationDialog(NewMainActivity.this,"Numele de utilizator sau parola sunt incorecte").show();
            } catch (JSONException e){
                new NotificationDialog(NewMainActivity.this,"Ne cerem scuze, dar platforma nu funcționează. Vă rugăm reveniți.").show();
                e.printStackTrace();
            }
        }else{
            new NotificationDialog(NewMainActivity.this,"Ne cerem scuze, dar platforma nu funcționează. Vă redirecţionăm spre secţiunea informaţii magazine.").show();
            Intent intent = new Intent(NewMainActivity.this, ShopMainActivity.class);
            startActivity(intent);
            finish();
        }
    }
