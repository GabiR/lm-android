<<<<<<< HEAD:app/src/main/java/com/cypien/leroy/activities/OldLoginActivity.java
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Connections.isNetworkConnected(getApplicationContext())) {
                    ...
                    new NotificationDialog(OldLoginActivity.this, "Pentru a vă putea reseta parola trebuie sa fiți conectat la internet!").show();
                }
            }
        });
        ...
        facebookLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                initFacebook();
                if (Connections.isNetworkConnected(getApplicationContext())) {
                    SimpleFacebook.getInstance(OldLoginActivity.this).login(new OnLoginListener() {
                        @Override
                            ...
                            SimpleFacebook.getInstance().getProfile(properties, new OnProfileListener() {
                                ...
                                public void onComplete(Profile profile) {
                                    if (profile.getEmail() != null) {
                                        ...
                                        new NotificationDialog(OldLoginActivity.this,"Nu vă puteți conecta prin Facebook întrucât nu ați fost de accord cu preluarea informațiilor dumneavoastră").show();
                                    }
                                }
                            });
                        }
                    ...
                    new NotificationDialog(OldLoginActivity.this,"Vă rugăm să vă conectați la internet pentru a putea intra în cont!").show();
                }
            }
        ...
        newAccountButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OldLoginActivity.this, AccountActivity.class);
        ...
        if(init()) {
            ...
            try {
                ...
                if (acces.contains("redirect_login")) {
                    ...
                    new NotificationDialog(OldLoginActivity.this,"Numele de utilizator sau parola sunt incorecte").show();
            } catch (JSONException e){
                new NotificationDialog(OldLoginActivity.this,"Ne cerem scuze, dar platforma nu funcționează. Vă rugăm reveniți.").show();
                e.printStackTrace();
            }
        }else{
            new NotificationDialog(OldLoginActivity.this,"Ne cerem scuze, dar platforma nu funcționează. Veti putea utiliza aplicatia in modul vizitator.").show();
            Intent intent = new Intent(OldLoginActivity.this,MainActivity.class);
            startActivity(intent);
            finish();
        }
...
>>>>>>> master:app/src/main/java/com/cypien/leroy/activities/OldLoginActivity.java
